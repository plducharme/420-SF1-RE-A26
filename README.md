...
![New project from Version Control](images/nouveau.png)
3. Sur lav ersion web de cette page (url disponible dans LEA), cliquer sur le bouton code en haut à droite du dépôt GitHub et copier l'URL du dépôt  
![Copier l'URL du dépôt](images/copier_url.png)
4. Coller l'URL dans PyCharm dans le champ `URL` et cliquer `clone`  
![Coller l'URL dans PyCharm](images/coller_url.png)
